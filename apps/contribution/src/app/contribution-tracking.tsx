      ...
      <Stack gap="lg">
        <div>
          ...
          <Text c="dimmed" size="lg">
            Monitor, verify, and reconcile all incoming pension contributions.
          </Text>
        </div>
        ...
        <Group>
          ...
          <Select
            ...
            data={['Reconciled', 'Pending', 'Overdue', 'Discrepancy']}
